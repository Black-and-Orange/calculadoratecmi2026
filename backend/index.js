...
const corsOptions = {
    origin: function (origin, callback) {
        ...
        const allowedOrigins = [
            ...
            // Dominio propio de staging BnO (blnolabs.dev)
            'https://calculadora-tecmi.blnolabs.dev',
            'https://admin-tecmi.blnolabs.dev',
        ];
        ...
        if (allowedOrigins.indexOf(origin) !== -1) {
            ...
            if (origin.includes('.testingbo.com') || origin.includes('.tecmilenio.mx') || origin.endsWith('calculadora-tecmi.pages.dev') || origin.endsWith('calculadora-tecmi-admin.pages.dev') || origin.endsWith('.blnolabs.dev')) {
                callback(null, true);
            } else {
